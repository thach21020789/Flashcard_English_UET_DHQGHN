...
let initWebRoutes = (app) => {
    ...
    router.get("/:category/:difficulty", loginController.checkLoggedIn, flashcardController.getVocab);
    router.get("/:category", loginController.checkLoggedIn, flashcardController.getVocab);
